...
namespace orange_stl
{
    ...
    bool operator<(const list<T> &lhs, const list<T> &rhs)
    {
        return orange_stl::lexicographical_compare(lhs.cbegin(), lhs.cend(), rhs.cbegin(), rhs.cend());
    }
