...
public:
    ...
    unordered_set(InputIterator first, InputIterator last, 
        ...
        : ht_(orange_stl::max(bucket_count, static_cast<size_type>(orange_stl::distance(first, last))), hash, equal)
    {
    ...
    unordered_set(std::initializer_list<value_type> ilist,
                  ...
                  const Hash& hash = Hash(),
                  const KeyEqual& equal = KeyEqual())
        : ht_(orange_stl::max(bucket_count, static_cast<size_type>(ilist.size())), hash, equal)
    {
    ...
    {
        return ht_.emplace_unique(orange_stl::forward<Args>(args)...);
    }

    template <class ...Args>
    iterator emplace_hint(const_iterator hint, Args&& ...args)
    {
        return ht_.emplace_unique_use_hint(hint, orange_stl::forward<Args>(args)...);
    }
    ...
    {
        return ht_.emplace_unique_use_hint(hint, orange_stl::move(value));
    }
...
public:
    ...
    pair<iterator, bool> emplace(Args&& ...args)
    {
        return ht_.emplace_multi(orange_stl::forward<Args>(args)...);
    }

    template <class ...Args>
    iterator emplace_hint(const_iterator hint, Args&& ...args)
    {
        return ht_.emplace_multi_use_hint(hint, orange_stl::forward<Args>(args)...);
    }
    ...
    pair<iterator, bool> insert(value_type&& value)
    {
        return ht_emplace_multi(orange_stl::move(value));
    }
    ...
    iterator insert(const_iterator hint, value_type&& value)
    {
        return ht_.emplace_multi_use_hint(hint, orange_stl::move(value));
    }
